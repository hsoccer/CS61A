...
(define berkeley (+ haruki 11))
; expect berkeley
berkeley
; expect 800

(define cs61a 'success)
; expect cs61a
cs61a
; expect success

(define chocolate 100)
; chocolate
chocolate
; expect 100
...
(+ haruki cs61a)
;Error: operand 1 (success) is not a number
...
(define (haruki kono) (lambda (berkeley) (+ kono berkeley)))
; expect haruki
((haruki 3) 5)
; expect 8
...
(define (haruki kono) (if #t kono 'berkeley))
; expect haruki
(haruki 3)
; expect 3
...
(+ haruki kono)
; expect 300
(let ((haruki 3) (kono 5)) (+ haruki kono))
; expect 8
...
(define (func i) (if (= i 0) #t (or #f (func (- i 1)))))
; expect func
(func 1000)
; true
